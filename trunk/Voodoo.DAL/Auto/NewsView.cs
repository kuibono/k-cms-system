    ...
    public partial class NewsView
    {
        ...
        protected static List<News> DataTableToList(DataTable dt)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                M.ContentEn = dt.Rows[i]["ContentEn"].ToString();
        ...
        public static void Insert(News M)
        {
            ...
            sb.Append("insert into [News]([NewsTime],[Title],[TitleB],[TitleI],[TitleS],[TitleColor],[FTitle],[Audit],[Tuijian],[Toutiao],[KeyWords],[NavUrl],[TitleImage],[Description],[Author],[AutorID],[Content],[ContentEn],[SetTop],[ModelID],[ClickCount],[DownCount],[FileForder],[FileName],[ZtID],[ClassID],[ReplyCount],[Source],[EnableReply]) values(");
            sb.Append("N'" + M.NewsTime + "'");
            sb.Append(",");
            sb.Append("N'" + M.Title + "'");
            sb.Append(",");
            ...
            sb.Append(",");
            sb.Append("N'" + M.TitleColor + "'");
            sb.Append(",");
            sb.Append("N'" + M.FTitle + "'");
            sb.Append(",");
            ...
            sb.Append(",");
            sb.Append("N'" + M.NavUrl + "'");
            sb.Append(",");
            sb.Append("N'" + M.TitleImage + "'");
            sb.Append(",");
        ...
        public static int Update(News M)
        {
            ...
            sb.Append("[NewsTime]=N'" + M.NewsTime + "'");
            sb.Append(",");
            ...
            sb.Append(",");
            sb.Append("[TitleColor]=N'" + M.TitleColor + "'");
            sb.Append(",");
            sb.Append("[FTitle]=N'" + M.FTitle + "'");
            sb.Append(",");
            ...
            sb.Append(",");
            sb.Append("[NavUrl]=N'" + M.NavUrl + "'");
            sb.Append(",");
            sb.Append("[TitleImage]=N'" + M.TitleImage + "'");
            sb.Append(",");
            ...
            sb.Append(",");
            sb.Append("[ContentEn]=N'" + M.ContentEn + "'");
            sb.Append(",");
            ...
            sb.Append(",");
            sb.Append("[FileForder]=N'" + M.FileForder + "'");
            sb.Append(",");
        ...
        public static News GetModelByID(string id)
        {
            IDbHelper Sql = GetHelper();
            News M = new News();
            DbDataReader Rs = Sql.ExecuteReader(CommandType.Text, "select [ID],[NewsTime],[Title],[TitleB],[TitleI],[TitleS],[TitleColor],[FTitle],[Audit],[Tuijian],[Toutiao],[KeyWords],[NavUrl],[TitleImage],[Description],[Author],[AutorID],[Content],[ContentEn],[SetTop],[ModelID],[ClickCount],[DownCount],[FileForder],[FileName],[ZtID],[ClassID],[ReplyCount],[Source],[EnableReply] from [News] where ID='" + id.ToString() + "'", true);
            if (!Rs.Read())
            {
                M.ID = 0;
            }
            else
            {
                ...
                M.ContentEn = Rs["ContentEn"].ToString();
        ...
        {
            IDbHelper Sql = GetHelper();
            return Sql.ExecuteDataTable(CommandType.Text, "select [ID],[NewsTime],[Title],[TitleB],[TitleI],[TitleS],[TitleColor],[FTitle],[Audit],[Tuijian],[Toutiao],[KeyWords],[NavUrl],[TitleImage],[Description],[Author],[AutorID],[Content],[ContentEn],[SetTop],[ModelID],[ClickCount],[DownCount],[FileForder],[FileName],[ZtID],[ClassID],[ReplyCount],[Source],[EnableReply] from [News] where " + m_where);
        }
        ...
        {
            IDbHelper Sql = GetHelper();
            DataTable dt = Sql.ExecuteDataTable(CommandType.Text, "select top " + top.ToString() + "  [ID],[NewsTime],[Title],[TitleB],[TitleI],[TitleS],[TitleColor],[FTitle],[Audit],[Tuijian],[Toutiao],[KeyWords],[NavUrl],[TitleImage],[Description],[Author],[AutorID],[Content],[ContentEn],[SetTop],[ModelID],[ClickCount],[DownCount],[FileForder],[FileName],[ZtID],[ClassID],[ReplyCount],[Source],[EnableReply] from [News] where " + m_where);
            return dt;
        }
        #endregion
