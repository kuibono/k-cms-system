<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="s.aspx.cs" Inherits="Web.wap.Book.s" %>
...
<head>
    ...
    <title><%=key %>-<%=SystemSetting.SiteName %></title>
        ...
        <div class="search-form-wrap">
            ...
            <div class="search-box">
                <div class="search-input-wrap">
                    <input type="text" class="search-input" name="key" maxlength="64" value="<%=key %>" /></div>
