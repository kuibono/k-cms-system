...
namespace Voodoo.DAL
{
	...
	///表MovieUrlMag的数据操作类
	///</summary>
    public partial class MovieUrlMagView
    {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        protected static List<MovieUrlMag> DataTableToList(DataTable dt)
        {
            List<MovieUrlMag> Ms = new List<MovieUrlMag>();
			
			for (int i = 0; i < dt.Rows.Count; i++)
            {
				MovieUrlMag M = new MovieUrlMag();
        ...
        /// <returns></returns>
		public static void Insert(MovieUrlMag M)
        {
            IDbHelper Sql = GetHelper();
            StringBuilder sb = new StringBuilder();			
			
			sb.Append("insert into [MovieUrlMag]([id],[MovieID],[MovieTitle],[Title],[UpdateTime],[Enable],[Url]) values(");
			...
			{
				sb.Append(";select max(id) from MovieUrlMag");	
			}
        ...
        /// <param name="M">赋值后的实体</param>
        /// <returns></returns>
		public static int Update(MovieUrlMag M)
        {
            IDbHelper Sql = GetHelper();
			StringBuilder sb = new StringBuilder();
            sb.Append("update [MovieUrlMag] set ");
        ...
        /// </summary>
        /// <param name="Ms"></param>
        public static void Update(List<MovieUrlMag> Ms)
        {
            foreach (MovieUrlMag M in Ms)
            {
                Update(M);
            }
        }
        ...
        /// <returns></returns>
		public static MovieUrlMag GetModelByID(string id)
		{
			IDbHelper Sql = GetHelper();
			MovieUrlMag M = new MovieUrlMag();
			DbDataReader Rs = Sql.ExecuteReader(CommandType.Text, "select [id],[MovieID],[MovieTitle],[Title],[UpdateTime],[Enable],[Url] from [MovieUrlMag] where Id='" + id.ToString()+"'", true);
			if (!Rs.Read())
			{
					M.Id=long.MinValue;
			}
        ...
        /// <returns></returns>
		public static MovieUrlMag Find(string m_where)
		{
			IDbHelper Sql = GetHelper();
            MovieUrlMag M = new MovieUrlMag();
            DbDataReader Rs = Sql.ExecuteReader(CommandType.Text, "select [id],[MovieID],[MovieTitle],[Title],[UpdateTime],[Enable],[Url] from [MovieUrlMag] where " + m_where, true);
			if (!Rs.Read())
            {
                M.Id = long.MinValue;
            }
		...
		{
			IDbHelper Sql = GetHelper();
            return Sql.ExecuteDataTable(CommandType.Text, "select [id],[MovieID],[MovieTitle],[Title],[UpdateTime],[Enable],[Url] from [MovieUrlMag] where "+ m_where);
		}
        ...
        {   
            IDbHelper Sql = GetHelper();
            DataTable dt = Sql.ExecuteDataTable(CommandType.Text, "select top "+ top.ToString() +"  [id],[MovieID],[MovieTitle],[Title],[UpdateTime],[Enable],[Url] from [MovieUrlMag] where "+ m_where);
            return dt;
        }
		#endregion
		...
		{
			IDbHelper Sql = GetHelper();
			return Convert.ToInt32(Sql.ExecuteScalar(CommandType.Text,"select count(0) from [MovieUrlMag] where "+m_where));
		}
		#endregion
		...
		public static bool Exist(string m_where)
		{
            ...
            sd = Sql.ExecuteReader(CommandType.Text, "select 1 from [MovieUrlMag] where " + m_where, true);
            if (sd.Read())
            {
                returnValue = true;
            }
		...
		#region List<MovieUrlMag>获取符合条件记录的实体列表,慎用！！！！
		/// <summary>
        /// List<MovieUrlMag>获取符合条件记录的实体列表,慎用！！！！
        /// </summary>
        /// <param name="m_where">条件语句，不包含“where”</param>
        /// <returns></returns>
		public static List<MovieUrlMag> GetModelList(string m_where)
		{	
			return DataTableToList(getTable(m_where));
		}
		public static List<MovieUrlMag> GetModelList(string m_where,int top)
		{	
			return DataTableToList(getTable(m_where, top));
		}
		public static List<MovieUrlMag> GetModelList()
        {
		...
		public static bool Del(string m_where)
		{
			...
			try
			{
				Sql.ExecuteNonQuery(CommandType.Text, "delete from [MovieUrlMag] where "+ m_where);
				return true;
			}
			catch
			{
