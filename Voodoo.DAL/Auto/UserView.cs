...
namespace Voodoo.DAL
{
    ...
    public partial class UserView
    {
		...
		public static void Insert(User M)
        {
			...
			sb.Append("N'"+M.Tel+"'");
			sb.Append(",");	
			sb.Append("N'"+M.Mobile+"'");
			sb.Append(",");	
			sb.Append("N'"+M.WebSite+"'");
			sb.Append(",");	
			sb.Append("N'"+M.Image+"'");
			sb.Append(",");	
			sb.Append("N'"+M.Address+"'");
			sb.Append(",");	
			sb.Append("N'"+M.ZipCode+"'");
			sb.Append(",");	
			sb.Append("N'"+M.Intro+"'");
			sb.Append(",");	
			sb.Append("N'"+M.RegTime+"'");
			sb.Append(",");	
			sb.Append("N'"+M.RegIP+"'");
			sb.Append(",");	
			...
			sb.Append(",");	
			sb.Append("N'"+M.StudentNo+"'");
			sb.Append(",");	
			sb.Append("N'"+M.TeachNo+"'");
			sb.Append(")");
		...
		public static int Update(User M)
        {
			...
			sb.Append("[QQ]=N'"+M.QQ+"'");
			sb.Append(",");
			sb.Append("[MSN]=N'"+M.MSN+"'");
			sb.Append(",");
			sb.Append("[Tel]=N'"+M.Tel+"'");
			sb.Append(",");
			sb.Append("[Mobile]=N'"+M.Mobile+"'");
			sb.Append(",");
			sb.Append("[WebSite]=N'"+M.WebSite+"'");
			sb.Append(",");
			sb.Append("[Image]=N'"+M.Image+"'");
			sb.Append(",");
			sb.Append("[Address]=N'"+M.Address+"'");
			sb.Append(",");
			sb.Append("[ZipCode]=N'"+M.ZipCode+"'");
			sb.Append(",");
			sb.Append("[Intro]=N'"+M.Intro+"'");
			sb.Append(",");
			sb.Append("[RegTime]=N'"+M.RegTime+"'");
			sb.Append(",");
			sb.Append("[RegIP]=N'"+M.RegIP+"'");
			sb.Append(",");
			...
			sb.Append(",");
			sb.Append("[GTalk]=N'"+M.GTalk+"'");
			sb.Append(",");
			sb.Append("[Twitter]=N'"+M.Twitter+"'");
			sb.Append(",");
			sb.Append("[weibo]=N'"+M.Weibo+"'");
			sb.Append(",");
			sb.Append("[ICQ]=N'"+M.ICQ+"'");
			sb.Append(",");
			sb.Append("[Group]="+M.Group.ToS());
			sb.Append(",");
			sb.Append("[Enable]="+M.Enable.ToS());
			sb.Append(",");
			sb.Append("[StudentNo]=N'"+M.StudentNo+"'");
			sb.Append(",");
			sb.Append("[TeachNo]=N'"+M.TeachNo+"'");
