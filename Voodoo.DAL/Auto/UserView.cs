...
namespace Voodoo.DAL
{
    ...
    public partial class UserView
    {
        ...
        public static void Insert(User M)
        {
            ...
            sb.Append("insert into [User](UserName,UserPass,Email,ChineseName,QQ,MSN,Tel,Mobile,WebSite,Image,Address,ZipCode,Intro,RegTime,RegIP,LoginCount,LastLoginTime,LastLoginIP,Cent,PostCount,GTalk,Twitter,weibo,ICQ,Group) values(");
        ...
        public static User GetModelByID(string id)
        {
            IDbHelper Sql = GetHelper();
            User M = new User();
            DbDataReader Rs = Sql.ExecuteReader(CommandType.Text, "select [ID],[UserName],[UserPass],[Email],[ChineseName],[QQ],[MSN],[Tel],[Mobile],[WebSite],[Image],[Address],[ZipCode],[Intro],[RegTime],[RegIP],[LoginCount],[LastLoginTime],[LastLoginIP],[Cent],[PostCount],[GTalk],[Twitter],[weibo],[ICQ],[Group] from [User] where ID='" + id.ToString() + "'", true);
            if (!Rs.Read())
            {
                M.ID = 0;
            }
        ...
        public static User Find(string m_where)
        {
            IDbHelper Sql = GetHelper();
            User M = new User();
            DbDataReader Rs = Sql.ExecuteReader(CommandType.Text, "select [ID],[UserName],[UserPass],[Email],[ChineseName],[QQ],[MSN],[Tel],[Mobile],[WebSite],[Image],[Address],[ZipCode],[Intro],[RegTime],[RegIP],[LoginCount],[LastLoginTime],[LastLoginIP],[Cent],[PostCount],[GTalk],[Twitter],[weibo],[ICQ],[Group] from [User] where " + m_where, true);
            if (!Rs.Read())
            {
                M.ID = 0;
            }
        ...
        {
            IDbHelper Sql = GetHelper();
            return Sql.ExecuteDataTable(CommandType.Text, "select [ID],[UserName],[UserPass],[Email],[ChineseName],[QQ],[MSN],[Tel],[Mobile],[WebSite],[Image],[Address],[ZipCode],[Intro],[RegTime],[RegIP],[LoginCount],[LastLoginTime],[LastLoginIP],[Cent],[PostCount],[GTalk],[Twitter],[weibo],[ICQ],[Group] from [User] where " + m_where);
        }
        ...
        {
            IDbHelper Sql = GetHelper();
            DataTable dt = Sql.ExecuteDataTable(CommandType.Text, "select top " + top.ToString() + "  [ID],[UserName],[UserPass],[Email],[ChineseName],[QQ],[MSN],[Tel],[Mobile],[WebSite],[Image],[Address],[ZipCode],[Intro],[RegTime],[RegIP],[LoginCount],[LastLoginTime],[LastLoginIP],[Cent],[PostCount],[GTalk],[Twitter],[weibo],[ICQ],[Group] from [User] where " + m_where);
            return dt;
        }
        #endregion
