    ...
    public partial class ClassView
    {
        ...
        protected static List<Class> DataTableToList(DataTable dt)
        {
			...
			for (int i = 0; i < dt.Rows.Count; i++)
            {
				...
				M.ParentClassForder=dt.Rows[i]["ParentClassForder"].ToString();
		...
		public static void Insert(Class M)
        {
			...
			sb.Append(",");	
			sb.Append("N'"+M.ParentClassForder+"'");
			sb.Append(",");	
			sb.Append("N'"+M.ClassForder+"'");
			sb.Append(",");	
			sb.Append(M.ModelID.ToS());
			sb.Append(",");	
			sb.Append("N'"+M.ClassKeywords+"'");
			sb.Append(",");	
			sb.Append("N'"+M.ClassDescription+"'");
			sb.Append(",");	
			sb.Append("N'"+M.ClassICON+"'");
			sb.Append(",");	
			sb.Append(M.ShowInNav.ToS());
			sb.Append(",");	
			sb.Append(M.NavIndex.ToS());
			sb.Append(",");	
			sb.Append("N'"+M.VisitRole+"'");
			sb.Append(",");	
			sb.Append(M.EnablePost.ToS());
			sb.Append(",");	
			sb.Append(M.EnableVCode.ToS());
			sb.Append(",");	
			sb.Append("N'"+M.PostRoles+"'");
			sb.Append(",");	
			...
			sb.Append(",");	
			sb.Append("N'"+M.ManagementOrder+"'");
			sb.Append(",");	
			sb.Append("N'"+M.ListPageOrder+"'");
			sb.Append(",");	
			sb.Append("N'"+M.ClassPageExtName+"'");
			sb.Append(",");	
			sb.Append(M.ListPageSize.ToS());
			sb.Append(",");	
			sb.Append("N'"+M.ContentPageForder+"'");
			sb.Append(",");	
			sb.Append("N'"+M.ContentPageExtName+"'");
			sb.Append(",");	
			sb.Append(M.ContentPageNameMode.ToS());
			sb.Append(",");	
			sb.Append("N'"+M.ContentPageDirMode+"'");
			sb.Append(")");
		...
		public static int Update(Class M)
        {
			...
			sb.Append(",");
			sb.Append("[Alter]=N'"+M.Alter+"'");
			sb.Append(",");
			sb.Append("[ParentID]="+M.ParentID.ToS());
			sb.Append(",");
			sb.Append("[IsLeafClass]="+M.IsLeafClass.ToS());
			sb.Append(",");
			sb.Append("[ParentClassForder]=N'"+M.ParentClassForder+"'");
			sb.Append(",");
			sb.Append("[ClassForder]=N'"+M.ClassForder+"'");
			sb.Append(",");
			sb.Append("[ModelID]="+M.ModelID.ToS());
			sb.Append(",");
			sb.Append("[ClassKeywords]=N'"+M.ClassKeywords+"'");
			sb.Append(",");
			sb.Append("[ClassDescription]=N'"+M.ClassDescription+"'");
			sb.Append(",");
			sb.Append("[ClassICON]=N'"+M.ClassICON+"'");
			sb.Append(",");
			sb.Append("[ShowInNav]="+M.ShowInNav.ToS());
			sb.Append(",");
			sb.Append("[NavIndex]="+M.NavIndex.ToS());
			sb.Append(",");
			sb.Append("[VisitRole]=N'"+M.VisitRole+"'");
			sb.Append(",");
			sb.Append("[EnablePost]="+M.EnablePost.ToS());
			sb.Append(",");
			sb.Append("[EnableVCode]="+M.EnableVCode.ToS());
			sb.Append(",");
			sb.Append("[PostRoles]=N'"+M.PostRoles+"'");
			sb.Append(",");
			...
			sb.Append(",");
			sb.Append("[ManagementOrder]=N'"+M.ManagementOrder+"'");
			sb.Append(",");
			sb.Append("[ListPageOrder]=N'"+M.ListPageOrder+"'");
			sb.Append(",");
			sb.Append("[ClassPageExtName]=N'"+M.ClassPageExtName+"'");
			sb.Append(",");
			sb.Append("[ListPageSize]="+M.ListPageSize.ToS());
			sb.Append(",");
			sb.Append("[ContentPageForder]=N'"+M.ContentPageForder+"'");
			sb.Append(",");
			sb.Append("[ContentPageExtName]=N'"+M.ContentPageExtName+"'");
			sb.Append(",");
			sb.Append("[ContentPageNameMode]="+M.ContentPageNameMode.ToS());
			sb.Append(",");
			sb.Append("[ContentPageDirMode]=N'"+M.ContentPageDirMode+"'");
		...
		public static Class GetModelByID(string id)
		{
			...
			else
			{
				...
				M.ParentClassForder=Rs["ParentClassForder"].ToString();
        ...
        {   
            IDbHelper Sql = GetHelper();
            DataTable dt = Sql.ExecuteDataTable(CommandType.Text, "select top "+ top.ToString() +"  [ID],[ClassName],[Alter],[ParentID],[IsLeafClass],[ParentClassForder],[ClassForder],[ModelID],[ClassKeywords],[ClassDescription],[ClassICON],[ShowInNav],[NavIndex],[VisitRole],[EnablePost],[EnableVCode],[PostRoles],[PostcreateList],[PostAddCent],[NeedAudit],[PostManagement],[EditcreateList],[EnableSameTitle],[AutoAudt],[EnableReply],[ReplyNeedAudit],[ListModel],[ContentModel],[ReplyModel],[SearchModel],[ClassPageMode],[ContentPageMode],[ManagementOrder],[ListPageOrder],[ClassPageExtName],[ListPageSize],[ContentPageForder],[ContentPageExtName],[ContentPageNameMode],[ContentPageDirMode] from [Class] where "+ m_where);
            return dt;
        }
		#endregion
