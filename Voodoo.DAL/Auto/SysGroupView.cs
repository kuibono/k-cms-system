...
namespace Voodoo.DAL
{
	...
	///表SysGroup的数据操作类
	///</summary>
    public partial class SysGroupView
    {
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        protected static List<SysGroup> DataTableToList(DataTable dt)
        {
            List<SysGroup> Ms = new List<SysGroup>();
        ...
        /// <returns></returns>
		public static void Insert(SysGroup M)
        {
			...
			{
				sb.Append(";select max(ID) from SysGroup");	
			}
        ...
        /// <param name="M">赋值后的实体</param>
        /// <returns></returns>
		public static int Update(SysGroup M)
        {
            IDbHelper Sql = GetHelper();
			StringBuilder sb = new StringBuilder();
        ...
        /// </summary>
        /// <param name="Ms"></param>
        public static void Update(List<SysGroup> Ms)
        {
            foreach (SysGroup M in Ms)
            {
                Update(M);
            }
        }
        ...
        /// <returns></returns>
		public static SysGroup GetModelByID(string id)
		{
			IDbHelper Sql = GetHelper();
			SysGroup M = new SysGroup();
        ...
        /// <returns></returns>
		public static SysGroup Find(string m_where)
		{
			IDbHelper Sql = GetHelper();
            SysGroup M = new SysGroup();
		...
		#region List<SysGroup>获取符合条件记录的实体列表,慎用！！！！
		/// <summary>
        /// List<SysGroup>获取符合条件记录的实体列表,慎用！！！！
        /// </summary>
        /// <param name="m_where">条件语句，不包含“where”</param>
        /// <returns></returns>
		public static List<SysGroup> GetModelList(string m_where)
		{	
			return DataTableToList(getTable(m_where));
		}
		public static List<SysGroup> GetModelList(string m_where,int top)
		{	
			return DataTableToList(getTable(m_where, top));
		}
		public static List<SysGroup> GetModelList()
        {
