...
(function($){
	...
	function insert_player(qvod_address)
	{
		...
		var qvodobj = $("#"+options.PlayerArea);
		/*向qvodobj中插入播放框架*/		
		qvodobj.html('<iframe id="iframe_down" name="iframe_down" scrolling="no" frameborder="0" style="margin: 0; width: 100%; height: 100%; display: none;" src=""></iframe><div id="qvod2011"><div class="playerarea" style="width:500px; heigth:400px; float:left;"><object classid="clsid:F3D0D36F-23F8-4682-A195-74C92B03D4AF" width="'+options.width+'" height="'+options.height+'" id="QvodPlayer" name="QvodPlayer" onError="document.getElementById(\'QvodPlayer\').style.display=\'none\';document.getElementById(\'iframe_down\').style.display=\'\';document.getElementById(\'iframe_down\').src=\'http://error2.qvod.com/error4.htm\';document.getElementById(\'qvod2011\').style.display=\'none\';"><PARAM NAME=\'URL\' VALUE=\''+qvod_address+'\'><param name=\'Showcontrol\' value=\''+options.ShowControl+'\'><pram name="NextWebPage" value="'+options.NextWebPage+'"><PARAM NAME=\'Autoplay\' VALUE=\''+options.AutoPlay+'\'><PARAM NAME=\'QvodAdUrl\' VALUE=\''+options.AdUrl+'\'><embed id="QvodPlayer2" name="QvodPlayer2" width="'+options.width+'" height="'+options.height+'" URL=\''+qvod_address+'\' type=\'application/qvod-plugin\' Autoplay=\''+options.AutoPlay+'\' QvodAdUrl="'+options.AdUrl+'" nextwebpage="'+options.NextWebPage+'" Showcontrol=\''+options.ShowControl+'\' ></embed></object></div>');
	}
